...
export default function Page1() {
  ...
  // const audioSrc =
  //   "https://res.cloudinary.com/dydh2rfnk/video/upload/v1737548658/page1Audio_vgvmcf.mp3";

  const audioSrc = "/images/page01/page1Audio.mp3"
            ...
            <div className="grid grid-rows-2">
              ...
              <div className="cursor-pointer relative">
                <div className="absolute inset-0 z-0">
                  <Image
                    src="/images/page01/bg1.png" // Dynamically set the background image
                    layout="fill"
                    objectFit="cover"
