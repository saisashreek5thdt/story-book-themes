                  ...
                  <div className="relative p-6 flex flex-col gap-4">
                    <div className="text-white text-lg text-justify font-medium py-20">
                      <p>
                        ...
                        <br />
                        successful landing of the Chandrayaan 3 on the moon.{" "}
                        <br /> His wise Dadaji makes use of this oppurtunity to
                        tell him all.
                      </p>
                      <p className="py-3">
                        Learn from Dadaji about India&apos;s past glory, about
                        ISRO, <br />
                        about grit and determination of our scientists in the{" "}
                        <br />
                        face of odds, and how they succeeded in their moon{" "}
                        <br /> mission, above all, about our great Prime
                        Minister <br /> Mr Narendra Modi who stood behind all
                        their efforts <br /> like a rock of Gibralter!
                      </p>
                      <p className="py-3">
                        A touching story of how sheer grit and determination,{" "}
                        <br />
