...
export default function Page1() {
    ...
    const [correctAnswer, setCorrectAnswer] = useState("Indian Space Research Organisation"); // Correct answer
    ...
    const options = [
        ...
        "Institute of Space Research and Operations",
        "Indian Space Research Organisation",
        "Indian Space and Rocket Organisation"
    ];
                        ...
                        <div className="flex justify-center flex-col gap-10 rounded-2xl bg-white shadow-xl p-8 w-full max-w-[600px]">
                            ...
                            <div className="grid grid-cols-2 grid-rows-2 gap-2">
                                {options.map((option, index) => (
                                    <div
                                        key={index}
                                        className={`text-base flex gap-2 items-center p-4 rounded-lg transition duration-300 ease-in-out cursor-pointer ${
