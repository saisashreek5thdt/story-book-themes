...
export default function Page1() {
    ...
    const options = ["23rd November", "23rd August", "23rd September", "23rd January"];
    ...
    const handleAnswer = () => {
        ...
        if (selectedAnswer === correctAnswer) {
            setNote(
                <>
                    <span className="text-green-600 font-bold">Correct!</span> This was done to commemorate the successful landing of Chandrayaan-3.
                </>
            );
        } else {
            setNote(
                <>
                    ...
                    <span className="font-bold">{correctAnswer}</span>. This was done to commemorate the successful landing of Chandrayaan-3.
                </>
            );
        }
